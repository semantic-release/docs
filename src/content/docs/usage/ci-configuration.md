...
| Variable    | Description                                                                                                                                                                                                                                                                                                                                                                   |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `NPM_TOKEN` | <p>npm token for publishing to npm. Trusted publishing is the preferred approach when publishing to the official registry. A token is required when publishing to alternative registries. See <a href="/recipes/ci-configurations/">CI configuration recipes</a> for setup options.</p> |
